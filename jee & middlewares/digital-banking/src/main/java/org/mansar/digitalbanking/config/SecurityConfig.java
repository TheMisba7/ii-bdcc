package org.mansar.digitalbanking.config;

import lombok.RequiredArgsConstructor;
import org.mansar.digitalbanking.security.filter.JwtAuthorizationFilter;
import org.mansar.digitalbanking.security.filter.LoginFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity https) throws Exception {
        ...
        https.cors(cus -> cus.configurationSource(corsConfig()));
