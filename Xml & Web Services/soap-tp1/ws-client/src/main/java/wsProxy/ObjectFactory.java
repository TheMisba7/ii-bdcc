...
public class ObjectFactory {
    ...
    private static final QName _Convert_QNAME = new QName("http://impl.ws.org/", "convert");
    private static final QName _ConvertResponse_QNAME = new QName("http://impl.ws.org/", "convertResponse");
    private static final QName _GetAccount_QNAME = new QName("http://impl.ws.org/", "getAccount");
    private static final QName _GetAccountResponse_QNAME = new QName("http://impl.ws.org/", "getAccountResponse");
    private static final QName _GetAccounts_QNAME = new QName("http://impl.ws.org/", "getAccounts");
    private static final QName _GetAccountsResponse_QNAME = new QName("http://impl.ws.org/", "getAccountsResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://impl.ws.org/", name = "convert")
     ...
     */
    @XmlElementDecl(namespace = "http://impl.ws.org/", name = "convertResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://impl.ws.org/", name = "getAccount")
     ...
     */
    @XmlElementDecl(namespace = "http://impl.ws.org/", name = "getAccountResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://impl.ws.org/", name = "getAccounts")
     ...
     */
    @XmlElementDecl(namespace = "http://impl.ws.org/", name = "getAccountsResponse")
